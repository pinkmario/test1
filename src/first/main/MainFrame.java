...
public class MainFrame {
	...
	private JTabbedPane createNavigationPanel() { // 创建导航标签面板的方法
		...
		baseManagePanel.setBackground(new Color(255, 255, 255));
		...
		baseManagePanel.add(createFrameButton("供应商信息管理", "GongYingShangGuanLi"));

		JPanel depotManagePanel = new JPanel(); // 库存管理面板
		depotManagePanel.setBackground(new Color(255, 255, 255));
		...
		sellManagePanel.setBackground(new Color(255, 255, 255));
		...
		searchStatisticPanel.setBackground(new Color(255, 255, 255));
		...
		stockManagePanel.setBackground(new Color(255, 255, 255));
		...
		sysManagePanel.setBackground(new Color(255, 255, 255));
		sysManagePanel
				.setLayout(new BoxLayout(sysManagePanel, BoxLayout.X_AXIS));
		if("a".equals(user.getQuan()))
