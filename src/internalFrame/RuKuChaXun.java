	...
	public RuKuChaXun() {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				...
				String sql = "select * from RuKu_view where ";
		...
		showallButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				content.setText("");
				List list = ShuJuKu.findForList("select * from RuKu_view");
		...
		String[] tableHeads = new String[]{"入库号码", "商品编号", "商品名称", "规格", "单价",
				"数量", "金额", "供应商全称", "入库日期", "操作员", "经手人", "结算方式","备注"};
