	...
	public RuKuTuiHuoChaXun() {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				...
				switch (condition.getSelectedIndex()) {//入库查询
					case 0 :
						conditionStr = "spname";
						break;
					case 1 :
		...
		showallButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				content.setText("");
				List list = ShuJuKu.findForList("select * from RuKuTuiHuo_view");
		...
		String[] tableHeads = new String[]{"入退号码", "商品编号", "商品名称", "规格", "单价",
				"数量", "金额", "供应商全称", "入退日期", "操作员", "经手人", "结算方式","备注"};
