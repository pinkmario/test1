...
public class XiaoShouTuiHuoChaXun extends JInternalFrame{
	...
	public XiaoShouTuiHuoChaXun() {
		...
		showAllButton.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				content.setText("");
				List list=ShuJuKu.findForList("select * from XiaoShouTuiHuo_view");
		...
		String[] tableHeads = new String[]{"销退号码", "商品编号", "商品名称", "规格", "单价",
				"数量", "金额", "客户全称", "退货日期", "操作员", "经手人", "结算方式","备注"};
	...
	private final class QueryAction implements ActionListener {
		public void actionPerformed(final ActionEvent e) {
			...
			list = ShuJuKu.findForList("select * from XiaoShouTuiHuo_view where "
					+ con
					+ opstr
					+ (oper == 0 ? "'"+cont+"'" : "'%" + cont + "%'")
