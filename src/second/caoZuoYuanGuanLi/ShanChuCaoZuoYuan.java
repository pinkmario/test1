...
import internalFrame.CaoZuoYuanGuanLi;
...
public class ShanChuCaoZuoYuan extends JPanel {
	...
	public ShanChuCaoZuoYuan() {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				...
				if (op == JOptionPane.OK_OPTION) {
					ShuJuKu.delete("delete from YongHuBiao where username='"
							+ loginName.getText() + "'");
					loginName.setText("");
					passField.setText("");
					userName.setText("");
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(final ActionEvent e) {
				CaoZuoYuanGuanLi parent = (CaoZuoYuanGuanLi) ShanChuCaoZuoYuan.this.getRootPane()
						.getParent();
